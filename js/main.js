    ...
    var i, r, s = o(78), a = o(19), l = o(10), u = o(0), c = o(82), d = o(9), h = 0, p = 0, f = function(e) {
        function o() {
            ...
            return t._onChangePath = function() {
                ...
                "/about/" == o ? n = "About " + n : "/works/" == o ? n = "Works " + n : -1 != (e = t.getWorksIndexByPath(o)) && (n = d.ConstWork.list[e].title ),
                document.title = n
            }
            ,
            t
      ...
      , l = function(e) {
        function t(t, o, n) {
            ...
            i._play = function(e) {
                void 0 === e && (e = !1),
                i.willPlay = !0
//                i.video && i.video.paused && !i.isPlaying && (e || (i.video.currentTime = 0),i.video.play())
            }
            ,
...
, function(e, t, o) {
    ...
    function a(e) {
        ...
        d.SC.slideHomePosition.innerHTML = h.splitTextElement("Front End Developer", "span"),
        d.SC.slideHomeName.innerHTML = h.splitTextElement("ASIF ANSARI", "span");
...
, function(e, t, o) {
    ...
    function n(e, t, o, n) {
        ...
        return TweenMax.set([c.SC.slideHomePosition, c.SC.slideHomeName], {
            x: e,
            y: t
        }),
        TimelinePlus.seri(TimelinePlus.para(TimelinePlus.para(TweenMax.to(c.SC.slideHomePosition, o, {
            ...
            autoAlpha: 1,
            ease: Ease._1_SineOut
        })).delay(i[1]), TimelinePlus.para(TweenMax.to(
            o, {
            x: 0,
            y: 0,
            scaleY: 1,
    ...
    function r(e, t, o, n) {
        ...
        return TimelinePlus.seri(TimelinePlus.para(TimelinePlus.para(TweenMax.to(c.SC.slideHomePosition, o, {
            ...
            autoAlpha: 0,
            ease: Ease._1_SineIn
        })).delay(i[1]), TimelinePlus.para(TweenMax.to(o, {
            x: e,
            y: t,
            scaleY: .5,
            ease: Ease._4_QuartIn
    ...
    var a, l, u = o(0), c = o(1), d = o(9), h = o(7), p = o(3), f = function() {
        function e() {
            ...
            this._onChangeSlideText = function() {
                ...
                l = i(v * t, v * o, .8, y))) : _ ? TweenMax.set([c.SC.slideHomePosition, c.SC.slideHomeName], {
                    autoAlpha: 1,
                    x: 1,
                    y: 1,
                    scaleY: 1
                ...
                l && l.kill(),
                _ ? TweenMax.set([c.SC.slideHomePosition, c.SC.slideHomeName, 
                     c.SC.slideWorksHeader, c.SC.slideWorksTitle, c.SC.slideWorksDescription, c.SC.slideWorksInfo], {
                    autoAlpha: 0
                }) : (a = r(-v * t, -v * o, .5, y),
                l = s(-v * t, -v * o, .5, y)))
            }
        ...
        return e.prototype.init = function() {
            ...
            TweenMax.set([c.SC.slideHomePosition, c.SC.slideHomeName, c.SC.slideWorksHeader, c.SC.slideWorksTitle, c.SC.slideWorksDescription, c.SC.slideWorksInfo], {
                autoAlpha: 0
            }),
            this
        }
        ...
        function e() {
            ...
            this._onChangeSlideText = function() {
                ...
                if (a.modelState.get("isSlideText")) {
                    ...
                    i.SC.slideNaviNextTitle.textContent = 0 == t ? "" : "",
                    i.SC.slideNaviPrevTitle.textContent = 0 == o ? "" : ""
                }
            }
        }
        return e.prototype.init = function() {
      ...
      , r = function(e) {
        function t() {
            ...
            t._onReadyXHR = function() {
                ...
                var binaryData = [];
                binaryData.push(t.xhr.response);
                t.video = document.createElement("video"),
                t.video.src = e.createObjectURL(new Blob(binaryData, {type: "application/zip"})),
                t.video.muted = !0,
                t.video.loop = !0,
                setTimeout(t._onReady, 250)
            }
